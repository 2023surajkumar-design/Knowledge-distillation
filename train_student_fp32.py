...
# Compatibility entry point. The maintained Task 2 implementation is under
# scripts/; exit before evaluating this historical dropped-in copy.
if __name__ == "__main__":
    from scripts.train_student_fp32 import main as _main
    _main()
    raise SystemExit
