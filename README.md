...
This workspace contains Task 1 only: a CIFAR-adapted, randomly initialized FP32 ResNet34 trained on CIFAR-10. It contains no knowledge distillation, ResNet18 student, ternarization, or QAT.
